This repository explains how to install Java on your system and how to run Java code in Visual Studio Code (VS Code).

**You will learn:**

1. How to download and install the latest Java Development Kit (JDK)
2. How to set up Java on Windows
3. How to install and configure VS Code for Java development
4. How to install the required extensions such as Java Extension Pack and Code Runner
5. How to run Java programs using the VS Code terminal
6. How to run Java programs using Code Runner
...
29. If Java is not running, go to Settings → search “code runner executor map” and verify the Java path is correct.
